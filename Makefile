...
.PHONY: test-analyzer
test-analyzer: ## Запустить тесты анализатора
...
.PHONY: demo
demo: ## Запустить демонстрацию базового протокола
	@echo "================================================"
...
.PHONY: demo-enum
demo-enum: ## Запустить демонстрацию enum-типов
	@echo "================================================"
...
.PHONY: demo-endian
demo-endian: ## Запустить демонстрацию LittleEndian
	@echo "================================================"
...
.PHONY: demo-aliases
demo-aliases: ## Запустить демонстрацию алиасов
	@echo "================================================"
...
.PHONY: load-bin
load-bin: build ## Загрузить схему из бинарного формата и показать код
